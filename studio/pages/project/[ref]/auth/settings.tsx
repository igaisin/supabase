...
const Settings = () => {
  ...
  const onFormSubmit = async (model: any) => {
    ...
    if (!model.SECURITY_CAPTCHA_PROVIDER_SECRET) {
      ...
      <div className="my-8 mt-0">
        <SchemaFormPanel
          ...
          schema={pluckJsonSchemaFields(authConfig, [
            ...
            'SECURITY_CAPTCHA_PROVIDER_SECRET',
          ])}
          model={{
            ...
            SECURITY_CAPTCHA_PROVIDER_SECRET: model.SECURITY_CAPTCHA_PROVIDER_SECRET || undefined,
            }}
        ...
        >
          ...
          <AutoField name="SECURITY_CAPTCHA_PROVIDER_SECRET" />
        </SchemaFormPanel>
      </div>
      <div className="my-8 mt-0">
        <SchemaFormPanel
